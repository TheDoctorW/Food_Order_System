...
class SearchingForm():
    ...
    def __init__(self, form):
        self._customer_id = Field('customer_id', [InputRequired('ID cannot be empty!')])
    ...
    def _parse(self, form):
        ...
        if self._customer_id.is_valid:
            if (self._customer_id.data).isdigit() == False:
                self._other_errors['customer_id_type'] = 'Please enter a valid number!'      
